    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      with pkgs;
      {
        checks = {
          ...
          ## This check runs clippy and rusfmt on all defined files in `fileset`, the rust files we have in this project
          rust-sanity-check =
            let
          ...
          ## This check runs black on check mode on all defined files in `fileset`, the python files we have in this project
          python-sanity-check =
            let
              fileSet = lib.fileset.unions [
                ./pyproject.toml
