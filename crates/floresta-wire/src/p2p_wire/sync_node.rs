...
///
/// see `crates/floresta-wire/src/p2p_wire/node_context.rs` and `crates/floresta-wire/src/p2p_wire/node.rs` for more information.
...
/// See `crates/floresta-wire/src/p2p_wire/node.rs` for more information.
    ...
    Chain: BlockchainInterface + UpdatableChainstate + 'static,
{
    ...
    ///     - Receives messages from the node_rx channel.
    ...
    /// Isolate inflights that have timed out and increase the banscore of the peer that sent them.
    ...
    ///
    /// This function bans the peer if the block is invalid, and requests a new block from another peer.
    ...
    /// From a message, this function process a message from a peer
