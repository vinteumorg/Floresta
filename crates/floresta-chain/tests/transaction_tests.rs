...
//! vectors in `testdata/bitcoin-core`. We then parse them and check the flags that are supported
//! by Floresta's consensus.
...
mod parse {
    ...
    // The tested transaction, the coins it spends, and the flags to use/exclude
