...
pub struct FlatChainStoreConfig {
    ...
    pub block_index_occupancy: Option<usize>,
...
impl FlatChainStoreConfig {
    ...
    pub fn new(path: String) -> Self {
        FlatChainStoreConfig {
            ...
            block_index_occupancy: Some(10_000_000),
...
impl FlatChainStore {
    ...
    /// It returns an error if the index is full. Note that this function will also increment the
    /// index occupancy, so it should not be called for updating existing entries.
    unsafe fn add_index_entry(
        ...
        if metadata.index_capacity == next_occupancy {
...
mod tests {
    ...
    fn get_test_chainstore() -> FlatChainStore {
        ...
        let config = super::FlatChainStoreConfig {
            block_index_occupancy: Some(32_768),
