...
impl PartialChainStateInner {
    ...
    pub fn process_block(
        ...
        if let Err(BlockchainError::BlockValidation(e)) = self
            .consensus
            .validate_block(block, &ancestor, height, inputs, flags, true, node_time)
        {
...
impl BlockchainInterface for PartialChainState {
    ...
    fn validate_block(
        ...
        note_time: &impl super::nodetime::NodeTime,
    ) -> Result<(), Self::Error> {
        ...
        inner.consensus.validate_block(
            block,
            ancestor,
            height,
            inputs,
...
mod tests {
    ...
    fn test_updating_single_chain() {
        ...
        let chain_time = &crate::pruned_utreexo::nodetime::DisableTime;
