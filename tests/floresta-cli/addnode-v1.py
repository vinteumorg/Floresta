...
class AddnodeTestV1(FlorestaTestFramework):
    ...
    def set_test_params(self):
        ...
        self.bitcoind = self.add_node_with_extra_args(
        ...
        self.bitcoind_url = self.bitcoind.p2p_url
    ...
    def test_should_floresta_add_bitcoind(self):
        ...
        self.assertEqual(peer_info[0]["address"], f"{self.bitcoind_url}")
    ...
    def test_should_floresta_not_add_bitcoind_again(self):
        ...
        result = self.florestad.rpc.addnode(
            node=self.bitcoind_url, command="add", v2transport=self.v2transport
        )
