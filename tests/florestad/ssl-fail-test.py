...
This functional test tests the failure on connect to florestad's TLS port.
"""
...
class TestSslFailInitialization(FlorestaTestFramework):
    ...
    def run_test(self):
        """
        Run the no-ssl node, create a electrum client that will try to connect to port 50002,
