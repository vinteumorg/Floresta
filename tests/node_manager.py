...
in integration test environments, including node creation,
...
class NodeManager:
    ...
    def setup_utreexod_daemon(
        ...
        Allows you to choose meaningful names for the data directory, 
        such as 'getblockchaininfo-bitcoin' or 'ping-floresta', 
        making it easier to identify the purpose of each test by its directory name.
        ...
        Args:
            ...
            variant: Daemon variant (e.g., 'bitcoin', 'floresta'), 
                also useful for descriptive names.
        """
        self.create_data_dir_for_daemon(
