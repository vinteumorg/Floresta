...
# Optional: Skip tests if certain conditions aren't met
...
def skip_if_no_binaries(request):
    ...
    # You can add logic here to check for specific binaries based on test markers
    if request.node.get_closest_marker("bitcoind"):
        bitcoind_path = os.path.join(binaries_dir, "bitcoind")  # adjust path as needed
