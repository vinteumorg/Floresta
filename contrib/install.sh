...
# Disclosure: from 0.7.0 the tarball isn't signed. From
# 0.8.0, the tarball will be signed.
# TODO: add signature verification when possible
download_floresta() {
    echo "🌳 Download floresta $defaultTag..."
    if ! curl -L -o "$tarDest" --retry 5 --retry-delay 10 "$tarSrc"; then
    ...
    sha256exp="d4ad23573a9c61d8d72b7e3b537a52c5202c936f4dbf3db6bf5c65b9508e4de4"
