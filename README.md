...
communication with other nodes. But you also can run a TLS enabled electrum
...
```bash
$ florestad --ssl-key-path=<path to private key> --ssl-cert-path=<path to certificate> --ssl-electrum-address=<ip>:<port>
```
