...
use floresta_cli::rpc_types::GetBackfillState;
use floresta_cli::rpc_types::GetUtreexoInfo;
use floresta_cli::rpc_types::SoftFork;
use serde_json::json;
...
use floresta_cli::rpc_types::GetBlockchainInfoRes;
...
impl RpcImpl {
    ...
    /// Return information about soft forks in the current chain.
    pub fn get_soft_forks(&self) -> Vec<SoftFork> {
        unimplemented!()
    }
}
...
impl RpcImpl {
    ...
    pub fn get_utreexo_info(&self) -> Result<GetUtreexoInfo, RpcError> {
        unimplemented!()
    }

    pub fn get_backfill_state(&self) -> Result<GetBackfillState, RpcError> {
        Ok(GetBackfillState { backfilling: self.node., backfillprogress: () })
    }
